...
export const Home = () => {
  return (
    < div className={style.container}>
      <Navbar></Navbar>
      <div className={style.overlay_left}></div>
      <div className={style.content}>
          <div className={`col-lg-12 ${style.container_left}`}>
            <div className=" ">
              <h2 className="display-5">Santhosh Kumar</h2>
              <h6>MCA Graduate</h6>
            </div>
            <div className={style.link_img_container}>
              <img src={linkedIn_logo} alt="Github" />
              <img src={gitHub_logo} alt="Linked In" />
              <img src={resume_logo} alt="Resume" />
            </div>
          </div>
          <div className={`col-lg-12 ${style.container_right}`}>
            <p>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Hello there! I'm a
